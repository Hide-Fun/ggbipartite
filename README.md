...
この README では、同一データから次の 3 系統の可視化を比較しました。

- abundance ベースで相互作用量を表現する方法
- binary ベースで接続の有無を強調する方法
- 系統樹との対応をリンク線または座標整列で示す方法

実際の解析では、「情報量を優先するか、可読性を優先するか」を図の目的に応じて使い分けることで、結果をより正確に伝えられるようになります。
